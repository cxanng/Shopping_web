 ...
 * @returns {boolean} true if url has ID component as its last part
 */
 ...
 *
 * @param {string} url filePath
 * @returns {boolean} whether the provided URL match /api/users/{id}
 */
 ...
 *
 * @param {string} url filePath
 * @returns {boolean} whether the provided URL match /api/products/{id}
 */
 ...
 *
 * @param {string} url filePath
 * @returns {boolean} whether the provided URL match /api/orders/{id}
 */
